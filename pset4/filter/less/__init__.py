...
def sepia_3x3():
    check50.log("testing 3x3...")
    run_test(Tests.input + FILES[0], Tests.output.sepia + FILES[0], "s")


@check50.check(compiles)
def sepia_4x4():
    check50.log("testing 4x4...")
    run_test(Tests.input + FILES[1], Tests.output.sepia + FILES[1], "s")


@check50.check(compiles)
def sepia_19x19():
    check50.log("testing 19x19...")
    run_test(Tests.input + FILES[2], Tests.output.sepia + FILES[2], "s")
