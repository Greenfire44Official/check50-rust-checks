...
def audio_half():
    ...
    check50.run(f"{EXEC} input.wav output.wav 0.5").exit(0)
...
def audio_tenth():
    ...
    check50.run(f"{EXEC} input.wav output.wav 0.1").exit(0)
...
def audio_x2():
    ...
    check50.run(f"{EXEC} input.wav output.wav 2").exit(0)
